...
pygame.display.set_caption("Mickey Mouse Clock")  # название

mickey_body = pygame.image.load("TSIS7\mickey.png")
left = pygame.image.load("TSIS7\handl.png")
right = pygame.image.load("TSIS7\handr.png")
