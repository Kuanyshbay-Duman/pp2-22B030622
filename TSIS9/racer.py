...
# background image
background = pygame.image.load("Week13\TSIS9\TOOLS\AnimatedStreet.png")

# Create a white screen
screen = pygame.display.set_mode((400, 600))
screen.fill(white)
pygame.display.set_caption("Game")
# weight of first coin
weight = 1
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        # enemy image
        self.image = pygame.image.load("Week13\TSIS9\TOOLS\Enemy.png")
...
class Coins(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(
            pygame.image.load("Week13\TSIS9\TOOLS\coin.png"), (20, 20))
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Week13\TSIS9\TOOLS\Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('Week13\TSIS9\TOOLS\crash.wav').play()
        time.sleep(0.5)
    ...
    if pygame.sprite.spritecollideany(P1, coinss):
        ...
        if collect > 10:
            speed = speed + 3
        for i in coinss:
            i.image = pygame.transform.scale(
            pygame.image.load("Week13\TSIS9\TOOLS\coin.png"), (20*weight, 20*weight))
